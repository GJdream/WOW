...
let baseURL = "http://wow.ohmyyouth.com/web/index.php/Web_service/";
let token = ""

let METHOD_LOGIN = "login"
let METHOD_SIGNUP = "signup"
...
class WebserviceCommunication: NSObject,URLSessionDownloadDelegate,URLSessionTaskDelegate{
    ...
    func httpPOSTEncodedString(methodName:String,dict:AnyObject?,callback:@escaping (_ result:AnyObject?,_ statusCode:Int? ,_ error:NSString?)->Void)
    {
        ...
        DispatchQueue.global(qos: .background).async {
            ...
            do {
               ...
               // let Data =  valuesString.data(using: String.Encoding.utf8)!
                let jsonData = try JSONSerialization.data(withJSONObject: dict as! NSDictionary , options: JSONSerialization.WritingOptions.prettyPrinted)
